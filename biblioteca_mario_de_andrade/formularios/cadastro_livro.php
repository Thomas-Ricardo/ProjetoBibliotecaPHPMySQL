...
<form class='form-control' action="http://localhost/biblioteca_mario_de_andrade/scripts/cadastro_livro_script.php" method="POST">
        <div class='titletop'>
            <h2><b>Cadastro de Livros</b></h2>
        </div><br>
        <div class='group'>
            <label for='nome'><b>Nome</b></label>
            <input class='form-control' type="text" name='nome_livro' placeholder="Nome do livro" required>
        </div><br>
        ...
        <div class='group'>
            ...
            <input class='form-control' type="date" name='data_pub' placeholder="" required>
        </div><br>
        <div class='group'>
            <label><b>Categoria</b></label>
            <input class='form-control' type="text" name='categoria' placeholder="Exemplo: Ação..." required>
        </div><br>
        <div>
            <label><b>Quantidade de Copias</b></label>
            <input  class='form-control' type="number" name="quantidade" id='quantidade' min="1" max="999">
        </div><br>
